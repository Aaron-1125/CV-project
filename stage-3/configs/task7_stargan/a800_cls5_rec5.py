"""Stage3 Task7 A800 StarGAN CelebA config: lambda_cls=5, lambda_rec=5."""

task_name = "stage3_task7_stargan_celeba_128_cls5_rec5"
seed = 20260603
...
train = dict(
    ...
    lr_update_step=1000,
    work_dir="work_dirs/task7/stargan_celeba_128_cls5_rec5",
...
reports = dict(
    report_dir="reports/task7_cls5_rec5",
    summary_dir="reports/task7_cls5_rec5/summaries",
    asset_dir="reports/task7_cls5_rec5/assets",
)
