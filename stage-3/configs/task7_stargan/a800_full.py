"""Stage3 Task7 full AutoDL A800 StarGAN CelebA config."""

task_name = "stage3_task7_stargan_celeba_128_full"
seed = 20260603
...
train = dict(
    ...
    lr_update_step=1000,
    work_dir="work_dirs/task7/stargan_celeba_128_full",
...
reports = dict(
    report_dir="reports/task7",
    summary_dir="reports/task7/summaries",
    asset_dir="reports/task7/assets",
)
